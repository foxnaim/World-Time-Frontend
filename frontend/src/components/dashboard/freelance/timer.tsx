      ...
      <Card className={cn('relative overflow-hidden', className)}>
        <div className="flex flex-col gap-6 md:flex-row md:items-end md:justify-between">
          <div>
            ...
            <h3
              className="mt-1 text-xl font-medium tracking-editorial text-[#3d3b38] md:text-2xl"
              style={{ fontFamily: 'Fraunces, serif' }}
            >
              {projectName}
            </h3>
            <div
              className="mt-4 text-5xl font-medium tracking-editorial text-[#3d3b38] md:text-6xl"
              style={{
    ...
    <Card className={cn(className)}>
      <div className="flex flex-col gap-6 md:flex-row md:items-end md:justify-between">
        <div className="flex-1">
          <span className="text-[10px] uppercase tracking-[0.28em] text-[#6b6966]">Таймер</span>
          <h3
            className="mt-1 text-xl font-medium tracking-editorial text-[#3d3b38] md:text-2xl"
            style={{ fontFamily: 'Fraunces, serif' }}
          >
          ...
          {hasProjects ? (
            ...
            <p className="mt-4 text-sm text-[#3d3b38]">
