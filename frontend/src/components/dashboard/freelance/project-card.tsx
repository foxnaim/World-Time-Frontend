    ...
    <Card className={cn('flex h-full flex-col justify-between gap-5', className)}>
      <div>
        <div className="flex items-start justify-between gap-3">
          <Link href={`/freelance/projects/${project.id}`} className="flex-1 no-underline">
            <h4
              className="text-xl font-medium tracking-editorial text-[#3d3b38]"
        ...
        <p className="mt-1 text-xs uppercase tracking-[0.22em] text-[#6b6966]">{rateLine}</p>
      ...
      <div className="flex flex-col gap-2">
        {warn && activeElsewhere && (
          <div className="rounded-xl border border-coral/40 bg-coral/10 p-3 text-xs text-[#3d3b38]">
            <p>
