        ...
        return (
          ...
          >
            ...
            <div className="min-w-0">
              <div
                className="text-base tracking-tight text-[#3d3b38] truncate"
              ...
              {e.position && (
                <div className="mt-1 text-[10px] uppercase tracking-[0.24em] text-[#6b6966]">
                  {e.position}
                </div>
              )}
            </div>
            <span
              className="text-xl tabular-nums text-[#3d3b38]"
              style={{ fontFamily: 'Fraunces, serif' }}
            >
              {e.score.toFixed(0)}
            </span>
